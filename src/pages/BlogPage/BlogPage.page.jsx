          ...
          <div className="row">
            ...
            <div className="col-lg-4 mb-5">
              <div className="post-entry d-block small-post-entry-v">
                <div className="thumbnail">
                  <a href="single.html">
                    <img src="assets/img_3.jpg" alt="" className="img-fluid" />
                  </a>
                </div>
                <div className="content">
                  <div className="post-meta mb-1">
            ...
            <div className="col-lg-4 mb-5">
              <div className="post-entry d-block small-post-entry-v">
                <div className="thumbnail">
                  <a href="single.html">
                    <img src="assets/img_4.jpg" alt="" className="img-fluid" />
                  </a>
                </div>
                <div className="content">
                  <div className="post-meta mb-1">
            ...
            <div className="col-lg-4 mb-5">
              <div className="post-entry d-block small-post-entry-v">
                <div className="thumbnail">
                  <a href="single.html">
                    <img src="assets/img_5.jpg" alt="" className="img-fluid" />
                  </a>
                </div>
                <div className="content">
                  <div className="post-meta mb-1">
            ...
            <div className="col-lg-4 mb-5">
              <div className="post-entry d-block small-post-entry-v">
                <div className="thumbnail">
                  <a href="single.html">
                    <img src="assets/img_6.jpg" alt="" className="img-fluid" />
                  </a>
                </div>
                <div className="content">
                  <div className="post-meta mb-1">
